...
pub(crate) const RULES: &[RuleInfo] = &[
    ...
    RuleInfo { id: "APO007", name: "hardcoded-secret", severity: Severity::High, message: "Embedded credential material requires review of secret storage and rotation; source evidence is redacted.", languages: "selected syntax across recognized languages; see docs/RULES.md" },
    RuleInfo { id: "APO008", name: "weak-crypto", severity: Severity::Medium, message: "Weak cryptographic primitive requires review of security purpose and algorithm selection.", languages: "selected syntax across recognized languages; see docs/RULES.md" },
    ...
    RuleInfo { id: "APO011", name: "sql-string-building", severity: Severity::Medium, message: "Dynamically assembled SQL requires review of parameterization and untrusted input.", languages: "selected syntax across recognized languages; see docs/RULES.md" },
    RuleInfo { id: "APO012", name: "path-traversal-sink", severity: Severity::Medium, message: "Variable filesystem path requires review of input validation and directory confinement.", languages: "selected syntax across recognized languages; see docs/RULES.md" },
