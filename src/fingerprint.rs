//! Stable SHA-256 identifiers. Not used for authentication or secret verification.
...
pub(crate) fn finding(rule: &str, path: &str, line: &str) -> String {
    sha256(format!("{rule}\0{path}\0{}", sha256(line.as_bytes())).as_bytes())
}
#[cfg(test)]
mod tests {
    use super::*;
